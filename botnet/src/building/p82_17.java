...
public class p82_17 extends javax.swing.JFrame {
 public Connection con;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                                 Packet Reception");
        ...
        jPanel4.setFont(new java.awt.Font("Narkisim", 0, 18)); // NOI18N
        ...
        jScrollPane1.setBounds(10, 20, 730, 230);

        jPanel1.add(jPanel4);
        jPanel4.setBounds(40, 60, 750, 260);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Socket rec1 = new Socket("localhost", 1204);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(p82_17.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
