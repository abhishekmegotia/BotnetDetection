...
public class p65_254 extends javax.swing.JFrame {
 ...
 public Connection con;
    ...
    private void initComponents() {
       ...
       // jPanel1.add(jButton2);
        jButton2.setBounds(510, 300, 160, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try {
            ...
            Socket rec1 = new Socket("localhost", 1207);
   JOptionPane.showMessageDialog(null, "PACKET RECEIVED");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(p65_254.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
