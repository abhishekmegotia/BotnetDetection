...
public class p58_34 extends javax.swing.JFrame {
 public Connection con;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                          Peer Timestamp Calculation");
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(550, 390, 90, 100);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try {
            ...
            Socket rec1 = new Socket("localhost", 1206);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(p58_34.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
