...
public class p211_14 extends javax.swing.JFrame {
 public Connection con;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                          Peer3 Timestamp Calculation");
        ...
        jScrollPane1.setBounds(20, 20, 720, 230);

        jPanel1.add(jPanel4);
        jPanel4.setBounds(50, 70, 750, 260);
        ...
        jButton1.setBounds(170, 410, 170, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Socket rec1 = new Socket("localhost", 1203);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(p211_14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
