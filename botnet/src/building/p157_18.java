...
public class p157_18 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                          Peer2 Timestamp Calculation");
        jLabel1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(jLabel1);
        jLabel1.setBounds(150, 10, 630, 30);
        ...
        jScrollPane1.setBounds(0, 30, 740, 220);
        ...
        jButton1.setBounds(270, 360, 190, 30);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/preceive.gif"))); // NOI18N
        jPanel1.add(jLabel3);
        jLabel3.setBounds(600, 330, 90, 100);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(30, 60, 850, 530);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Socket rec1 = new Socket("localhost", 1202);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(p157_18.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
