...
public class p123_88 extends javax.swing.JFrame {
...
//            UIManager.setLookAndFeel(new com.sun.java.swing.plaf.windows.WindowsClassicLookAndFeel());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try {
            ...
            Socket rec1 = new Socket("localhost", 1251);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(p123_88.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
